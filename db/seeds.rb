...
TitleObtained.create(title_type: 'pastor', name: 'Pastor', code:1)
TitleObtained.create(title_type: 'lider', name: 'Líder', code: 2)
TitleObtained.create(title_type: 'miembro', name: 'Miembro', code: 3)
TitleObtained.create(title_type: 'visita', name: 'Visita', code: 4)
TitleObtained.create(title_type: 'prospecto', name: 'Prospecto', code: 5)
